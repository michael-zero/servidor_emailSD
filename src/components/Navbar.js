...
const Navbar = () => {
 ...
 const[botoes,setBoteos]=React.useState([
    ...
    <img src={usuario} alt="usuario" className='ml-0 avatar botao'/>
    ]);
    ...
    return (
        ...
        <li className="list-inline-item">
            <i className="fa fa-bars botao" aria-hidden="true"></i> </li>
        <li className="list-inline-item">  
